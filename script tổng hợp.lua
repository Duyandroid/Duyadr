...
ImageButton.Image = "https://raw.githubusercontent.com/Duyandroid/Duyadr/refs/heads/main/bright.png"
...
local Tabs = {
    Main0=Window:AddTab({Title="MENU"}),
...
print("Duy Trường loaded successfully!")
