--==================================================
-- IOS VIET - FINAL GOD LOCAL VERSION
--==================================================

--================ CONFIG =================
local ADMIN_USER = "Duy Trường"
local ADMIN_PASS = "Duy Trường"

local FIXED_KEY = "Duy Trường"
local FIXED_DAYS = 5
local FIXED_LIMIT = 50

local TIKTOK_LINK = "https://discord.gg/DGJpntrPzj"
local MAIN_SCRIPT = "https://raw.githubusercontent.com/Duyandroid/Duyadr/refs/heads/main/iosviet.lua"
local SAVE_FILE = "iosviet_dtr_data.json"
--========================================
