...
local v13 = loadstring(game:HttpGet("https://raw.githubusercontent.com/Duyandroid/Duyandroid/refs/heads/main/flast%20attack_1.lua"))();
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=130379077525916";
        ...
        while wait() do
            pcall(function()
                if (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88) then
                    v491:SetDesc("Left: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 41) .. "");
...
if Sea3 then
    local v498 = v16.Sea:AddSection("Kitsune Island Status");
...
if Sea3 then
    ...
    spawn(function()
        pcall(function()
            while wait() do
                v532:SetDesc("Mirage: " .. MirageStatus .. " | Full Moon: " .. FullMoonStatus);
            end
        end);
    end);
    v16.Sea:AddButton({
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://83190276951914") then --thay id ảnh vào
                    return v729;
                end
            end
        end
        ...
        pcall(function()
            if _G.Auto_ObservationV2 then
                if (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CitizenQuestProgress", "Citizen") == 3) then
                    ...
                    if (game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Duy Android") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Apple") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Pineapple")) then
                        repeat
                    ...
                    elseif (game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fruit Bowl") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fruit Bowl")) then
                        ...
                        for v1561, v1562 in pairs(game:GetService("Workspace"):GetDescendants()) do
                            if ((v1562.Name == "Apple") or (v1562.Name == "Duy Android") or (v1562.Name == "Pineapple")) then
...
local v93 = v16.Setting:AddSection("Skill");
...
local v56 = v16.Player:AddSection("Other");
...
local v118 = v16.Teleport:AddSection("Sea");
...
local v56 = v16.Fruit:AddSection("Esp");
...
local v142 = v16.Raid:AddToggle("ToggleGetFruit", {
    Title = "Give Up Normal Fruit—>Raid Chip",
    Description = "",
    Default = false
});
...
local v56 = v16.Raid:AddSection("Law");
...
local v56 = v16.Shop:AddSection("Other");
v16.Shop:AddButton({
    Title = "Reset Stats",
    Description = "",
    Callback = function()
...
local v56 = v16.Misc:AddSection("Titles");
v16.Misc:AddButton({
    Title = "Titles",
    Description = "",
    Callback = function()
...
local v56 = v16.Misc:AddSection("Misc");
